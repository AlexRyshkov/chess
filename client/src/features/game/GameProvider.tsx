...
import {Bishop, Figure, Grid, King, Knight, Pawn, Queen, Rook, Side} from '../figures/figure';
...
const GameProvider = ({children}: { children: ReactElement }) => {
    ...
    return (
        <GameContext.Provider
            value={{grid, dragAllowedCells, makeMove, currentSideMove, history, isCheck, isMate, playerSide}}
        >
            {children}
        </GameContext.Provider>
    );
